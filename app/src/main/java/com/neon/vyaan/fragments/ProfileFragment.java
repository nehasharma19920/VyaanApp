...
public class ProfileFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        containerUserImage = (LinearLayout) view.findViewById(R.id.containerUserImage);
        LinearLayout imageUserProfile = (LinearLayout) view.findViewById(R.id.containerUserImage);
