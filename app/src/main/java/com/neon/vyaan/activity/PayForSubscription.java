...
/**
 * Created by Mayank on 27/09/2016.
 */


public class PayForSubscription extends BaseActivity {
    ...
    protected void initContext() {
        currentActivity = PayForSubscription.this;
        context = PayForSubscription.this;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // amount = 1;
            subscriptionId = getIntent().getStringExtra("MONTHLY_SUBSCRIPTION_ID");
...
//                    alert(currentActivity, getString(R.string.message_order_placed_popuop), getString(R.string.message_order_placed_popuop), getString(R.string.labelOk), getString(R.string.labelCancel), false, false, ALERT_TYPE_NO_NETWORK);
                    ...
                    toast("Subscription payment successfull", true);
                    if (bundle == null) {
                        bundle = new Bundle();

                    }
                    bundle.putString(AppConstants.KEY_PAY_FOR_SUBSCRIPTION, AppConstants.KEY_PAY_FOR_SUBSCRIPTION);

                    Intent i = new Intent(PayForSubscription.this, Dashboard.class);
                    i.putExtras(bundle);
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                Log.e("override page", url.toString());
 ...
 /*       String key = "gtKFFx";//"JBZaLc";
      ...
      /*  production credenials*/
        ...
        String firstname = SharedPreferenceUtils.getInstance(PayForSubscription.this).getString(AppConstants.KEY_USER_NAME);
       /* firstname = "mayank";*/
        String email = SharedPreferenceUtils.getInstance(PayForSubscription.this).getString(AppConstants.KEY_USER_EMAIL);
        String productInfo = subscriptionId;
